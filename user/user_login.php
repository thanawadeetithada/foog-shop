...
<head>
    ...
    * {
    ...
    .login-container {
    background-color: #FDDF59; /* สีพื้นหลัง */
    padding: 2rem;
    width: 90%;
    max-width: 400px;
    border-radius: 15px;
...
.top-tab {
    ...
    padding: 30px; /* ระยะห่างด้านใน 20px */
    background-color: #FDDF59; /* สีพื้นหลังของแท็บ */
    position: fixed; /* ตรึงไว้ที่ด้านบน */
    top: 0; /* ให้ติดด้านบนของหน้าจอ */
    left: 0; /* ชิดซ้ายสุด */
    z-index: 1000; /* ให้ซ้อนอยู่บนสุด */
}
    </style>
</head>
...
<div class="login-wrapper">
        <h2 class="login-title">เข้าสู่ระบบผู้ใช้</h2>
